...
{
    public class SuspendPostOrderCommandHandler : IRequestHandler<SuspendPostOrderCommand, BaseResponse<List<PostSuspendOrderResponse>>>
    {
        private readonly IConfiguration _configuration;
        private readonly CourierConfig _gateway;
        private readonly IMediator _mediator;

        public SuspendPostOrderCommandHandler(IConfiguration configuration, IMediator mediator)
        {
        ...
        public async Task<BaseResponse<List<PostSuspendOrderResponse>>> Handle(SuspendPostOrderCommand request, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private async Task<HttpResponseMessage> SetHttpRequest(string token, SuspendPostOrderCommand request)
        {
