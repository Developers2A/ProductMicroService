...
{
    public class GetPostProvincesQueryHandler : IRequestHandler<GetPostProvincesQuery, BaseResponse<List<PostGetProvincesResponse>>>
    {
        private readonly IConfiguration _configuration;
        private readonly CourierConfig _gateway;
        private readonly IMediator _mediator;

        public GetPostProvincesQueryHandler(IConfiguration configuration, IMediator mediator)
        {
        ...
        public async Task<BaseResponse<List<PostGetProvincesResponse>>> Handle(GetPostProvincesQuery request, CancellationToken cancellationToken)
        {
            BaseResponse<List<PostGetProvincesResponse>> result = new();
            try
            {
                ...
                try
                {
                    var resModel = JsonConvert.DeserializeObject<PostResponse<List<PostGetProvincesResponse>>>(res);
        ...
        private async Task<HttpResponseMessage> SetHttpRequest(string token, GetPostProvincesQuery request)
        {
