...
{
    public class CourierServiceZoneConfiguration : BaseEntityConfiguration<CourierServiceZone>
    {
        public override void Configure(EntityTypeBuilder<CourierServiceZone> builder)
        {
