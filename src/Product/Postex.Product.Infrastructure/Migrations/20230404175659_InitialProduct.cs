        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractBoxPrices_BoxTypes_BoxTypeId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContractCollectionDistributions_BoxTypes_BoxTypeId",
                        column: x => x.BoxTypeId,
                        principalTable: "BoxTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContractValueAddeds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ContractValueAddeds_ContractInfos_ContractInfoId",
                        column: x => x.ContractInfoId,
                        principalTable: "ContractInfos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContractValueAddeds_ValueAddedTypes_ValueAddedTypeId",
                        column: x => x.ValueAddedTypeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SameProvince = table.Column<bool>(type: "bit", nullable: false),
                    RowVersion = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: false),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ModifiedOn = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.InsertData(
                table: "ValueAddedTypes",
                columns: new[] { "Id", "CreatedBy", "CreatedOn", "IsRemoved", "ModifiedBy", "ModifiedOn", "Name", "RemovedOn" },
                values: new object[,]
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContractValueAddeds_ContractInfoId",
                table: "ContractValueAddeds",
                column: "ContractInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_ContractValueAddeds_ValueAddedTypeId",
                table: "ContractValueAddeds",
