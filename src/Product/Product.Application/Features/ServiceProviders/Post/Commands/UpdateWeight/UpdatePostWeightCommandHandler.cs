...
{
    public class UpdatePostWeightCommandHandler : IRequestHandler<UpdatePostWeightCommand, BaseResponse<PostEditWeightResponse>>
    {
        private readonly IConfiguration _configuration;
        private readonly CourierConfig _gateway;
        private readonly IMediator _mediator;

        public UpdatePostWeightCommandHandler(IConfiguration configuration, IMediator mediator)
        {
        ...
        public async Task<BaseResponse<PostEditWeightResponse>> Handle(UpdatePostWeightCommand request, CancellationToken cancellationToken)
        {
            try
            {
        ...
        private async Task<HttpResponseMessage> SetHttpRequest(string token, UpdatePostWeightCommand request)
        {
            ...
            var pUrl = new Uri($"{_gateway.BaseUrl}Parcel/EditWeight");
