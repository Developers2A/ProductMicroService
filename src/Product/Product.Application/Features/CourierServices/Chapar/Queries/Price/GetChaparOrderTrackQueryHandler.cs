...
{
    public class GetChaparOrderTrackQueryHandler : IRequestHandler<GetChaparPriceQuery, BaseResponse<ChaparGetPriceResponse>>
    {
        private readonly IConfiguration _configuration;
        private readonly CourierConfig _gateway;

        public GetChaparOrderTrackQueryHandler(IConfiguration configuration)
        {
