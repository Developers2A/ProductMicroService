...
namespace Product.Application.Features.CourierServices.Tarrof.Queries.Track
{
    public class GetPostTokenQueryHandler : IRequestHandler<GetPostOrderTrackQuery, string>
    {
        ...
        public async Task<string> Handle(GetPostOrderTrackQuery request, CancellationToken cancellationToken)
        {
