...
{
    public class CreateOrderCommandHandler : IRequestHandler<CreateOrderCommand, BaseResponse<PostCreateOrderResponse>>
    {
        private readonly IConfiguration _configuration;
        private readonly CourierConfig _gateway;
        private readonly IMediator _mediator;

        public CreateOrderCommandHandler(IConfiguration configuration, IMediator mediator)
        {
        ...
        public async Task<BaseResponse<PostCreateOrderResponse>> Handle(CreateOrderCommand request, CancellationToken cancellationToken)
        {
        ...
        private async Task<HttpResponseMessage> SetHttpRequest(string token, CreateOrderCommand request)
        {
