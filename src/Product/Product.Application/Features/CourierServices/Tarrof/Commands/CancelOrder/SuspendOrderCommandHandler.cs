...
{
    public class SuspendOrderCommandHandler : IRequestHandler<SuspendOrderCommand, BaseResponse<PostSuspendOrderResponse>>
    {
        ...
        public async Task<BaseResponse<PostSuspendOrderResponse>> Handle(SuspendOrderCommand request, CancellationToken cancellationToken)
        {
            BaseResponse<PostSuspendOrderResponse> result = new();
            try
            {
                ...
                try
                {
                    var resModel = JsonConvert.DeserializeObject<PostResponse<PostSuspendOrderResponse>>(res);
