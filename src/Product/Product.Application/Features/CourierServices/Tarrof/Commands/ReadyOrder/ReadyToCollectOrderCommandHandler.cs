...
{
    public class ReadyToCollectOrderCommandHandler : IRequestHandler<ReadyToCollectOrderCommand, BaseResponse<PostReadyToCollectResponse>>
    {
        ...
        public async Task<BaseResponse<PostReadyToCollectResponse>> Handle(ReadyToCollectOrderCommand request, CancellationToken cancellationToken)
        {
            BaseResponse<PostReadyToCollectResponse> result = new();
            try
            {
                ...
                try
                {
                    var resModel = JsonConvert.DeserializeObject<PostResponse<PostReadyToCollectResponse>>(res);
