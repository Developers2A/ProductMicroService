...
{
    public class DeleteOrderCommandHandler : IRequestHandler<DeleteOrderCommand, BaseResponse<PostDeleteOrderResponse>>
    {
        ...
        public async Task<BaseResponse<PostDeleteOrderResponse>> Handle(DeleteOrderCommand request, CancellationToken cancellationToken)
        {
            BaseResponse<PostDeleteOrderResponse> result = new();
            try
            {
                ...
                try
                {
                    var resModel = JsonConvert.DeserializeObject<PostResponse<PostDeleteOrderResponse>>(res);
